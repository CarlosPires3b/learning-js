...
console.log("Show!" * 2) // = o javascript não entende = Not a Number(NaN)
console.log(0.1 + 0.7) // imprecisão por números flutuantes
 // console.log(10.toString()) = Não pode converter sendo literal
